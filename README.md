...
use HTML forms.
Here's an example to use as a guideline ( The example page is to get inspire from the layout but to do the work on a portfolio page following instructions below )
